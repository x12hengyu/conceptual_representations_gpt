...
# gpt pairwise gpt3
gpt3_pairwise <- read.csv('data/pairwise/pairwise_response_davinci-002_matrix.csv')
gpt3_pairwise_cosine_dist = 1-lsa::cosine(t(data.matrix(gpt3_pairwise[,2:ncol(gpt3_pairwise)])))
gpt3_pairwise_mds <- cmdscale(gpt3_pairwise_cosine_dist, k = 3)
rownames(gpt3_pairwise_cosine_dist) <- gpt3_pairwise$X
colnames(gpt3_pairwise_cosine_dist) <- gpt3_pairwise$X
rownames(gpt3_pairwise_mds) = rownames(gpt3_pairwise_cosine_dist)
gpt3_pairwise_mds <- gpt3_pairwise_mds[order(rownames(gpt3_pairwise_mds)),]
```
...
matrices = list(leuven_mds, w2v_mds, clip_mds, unverified_gpt_mds_summer_no_mc, verified_gpt_mds_summer_no_mc, human_triplet_mds, gpt_triplet_mds, gpt_embed_mds, flan_xl_mds, flan_xxl_mds, gpt_pairwise_mds, gpt3_pairwise_mds)
...
matrix_names = list("leuven", "w2v", "clip", "unverified_gpt_summer_no_mc", "verified_gpt_summer_no_mc", "human_triplet", "gpt_triplet", "gpt_embed_mds", "flan_xl_mds", "flan_xxl_mds", "gpt_pairwise_mds", "gpt3_pairwise_mds")
...
#####EVERYTHING ABOVE IS REQUIRED FOR HEATMAP#####
